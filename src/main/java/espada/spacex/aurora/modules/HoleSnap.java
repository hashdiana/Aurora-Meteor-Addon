...
public class HoleSnap extends Modules {
    public HoleSnap() {
        super(Aurora.ExtendMove, "Hole Snap", "For the times when you cant even press W.");
    }
    ...
    private void onMove(PlayerMoveEvent event) {
        if (mc.player != null && mc.world != null) {
            ...
            if (hole != null && !singleBlocked()) {
                meteordevelopment.meteorclient.systems.modules.Modules.get().get(Timer.class).setOverride(timer.get());
