...
import static espada.spacex.aurora.utils.OLEPOSSUtils.replaceable;
...
public class AutoCraftingTable extends Modules {
    public AutoCraftingTable() {
        super(Aurora.AURORA, "Auto Crafting Table", "Automatically places and opens an Crafting table.");
    }
