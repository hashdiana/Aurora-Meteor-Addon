...
public class ListenerExtrapolation {
    private static Map<AbstractClientPlayerEntity, List<Vec3d>> motions = new HashMap<>();

    @PreInit
    public static void preInit() {
        MeteorClient.EVENT_BUS.subscribe(ListenerExtrapolation.class);
    }
    ...
    public static void extrapolateblock(ClientPlayerEntity integer) {
    }
