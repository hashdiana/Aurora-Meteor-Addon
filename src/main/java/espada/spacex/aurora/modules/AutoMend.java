...
public class AutoMend extends Modules {
    public AutoMend() {
        super(Aurora.EAncillary, "Auto Mend", "Automatically mends your armor with experience bottles.");
    }
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (AutoCrystal.placing) acTimer = autoCrystalTicks.get();
    ...
    private void onTick(TickEvent.Pre event) {
        if (mc.player == null || mc.world == null || meteordevelopment.meteorclient.systems.modules.Modules.get().isActive(Suicide.class)) return;
