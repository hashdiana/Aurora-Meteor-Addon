...
public class ScaffoldPlus extends Modules {
    public ScaffoldPlus() {
        super(Aurora.Extendcombat, "Scaffold+", "KasumsSoft blockwalk.");
    }
    ...
    public void onDeactivate() {
        switch (scaffoldMode.get()) {
            case Normal -> {
                ...
                meteordevelopment.meteorclient.systems.modules.Modules.get().get(Timer.class).setOverride(1);
                if (meteordevelopment.meteorclient.systems.modules.Modules.get().get(SafeWalk.class).isActive()) {
                    meteordevelopment.meteorclient.systems.modules.Modules.get().get(SafeWalk.class).toggle();
                }
            }
    ...
    private void onMove(PlayerMoveEvent event) {
        ...
        if (hand != null || ((switchMode.get() == SwitchMode.PickSilent || switchMode.get() == SwitchMode.InvSwitch) && inventory.slot() >= 0) ||
            ...
            if (safeWalk.get() && !meteordevelopment.meteorclient.systems.modules.Modules.get().get(SafeWalk.class).isActive()) {
                meteordevelopment.meteorclient.systems.modules.Modules.get().get(SafeWalk.class).toggle();
            }
            ...
            if (useTimer.get()) meteordevelopment.meteorclient.systems.modules.Modules.get().get(Timer.class).setOverride(timer.get());
