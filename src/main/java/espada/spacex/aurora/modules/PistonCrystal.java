...
public class PistonCrystal extends Modules {
    public PistonCrystal() {
        super(Aurora.AURORA, "Piston Crystal", "Pushes crystals into your enemies to deal massive damage.");
    }
    ...
    private void mineUpdate() {
        ...
        if (autoMine.isActive()) {
            ...
            Direction dir = SettingUtils.getPlaceOnDirection(redstonePos);
            autoMine.onStart(redstonePos, dir);
        } else {
