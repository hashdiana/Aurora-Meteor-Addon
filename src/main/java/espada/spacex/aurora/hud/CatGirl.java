...
public class CatGirl extends HudElement {
    ...
    private final Identifier catgirl = new Identifier("aurora", "catgirl.png");

    public static final HudElementInfo<CatGirl> INFO = new HudElementInfo<>(Aurora.HUD_EDIT, "catgirl", "It's a Cat girl what do you want", CatGirl::new);
