...
public class ArmorHudPlus extends HudElement {
    ...
    public static final HudElementInfo<ArmorHudPlus> INFO = new HudElementInfo<>(Aurora.HUD_EDIT, "ArmorHud+", "A target hud the fuck you thinkin bruv.", ArmorHudPlus::new);
