...
public class TimerPlusHud extends HudElement {
    public static final HudElementInfo<TimerPlusHud> INFO = new HudElementInfo<>(Aurora.HUD_EDIT, "timer-plus", "Displays timer plus charge.", TimerPlusHud::new);
    ...
    private void render(HudRenderer renderer, String right, Color rightColor) {
        ...
        double x2 = renderer.text("TimerChange: ", x, y, textColor.get(), shadow.get(), getScale());
