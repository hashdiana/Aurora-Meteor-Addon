...
public class HudWaterMark extends HudElement {
    ...
    private final Identifier LOGO = new Identifier("aurora", "logo.png");

    public static final HudElementInfo<HudWaterMark> INFO = new HudElementInfo<>(Aurora.HUD_EDIT, "WaterMARK", "The watermark.", HudWaterMark::new);
    ...
    public void render(HudRenderer renderer) {
        setSize(renderer.textWidth(Aurora.NAME + " " + Aurora.VERSION, true) * scale.get() * scale.get(), renderer.textHeight(true) * scale.get() * scale.get());

        String text = Aurora.NAME + " " + Aurora.VERSION;
        ...
        Renderer2D.TEXTURE.texQuad(x + renderer.textWidth(Aurora.NAME + " " + Aurora.VERSION) * scale.get() * scale.get(),
