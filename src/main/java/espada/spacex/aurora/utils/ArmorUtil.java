...
public class ArmorUtil {
    public static boolean checkThreshold(ItemStack i, double threshold) {
        return ArmorUtil.getDamage(i) <= threshold;
    }
    ...
    public static boolean isHelm(ItemStack itemStack) {
        ...
        if (itemStack.getItem() == Items.CHAINMAIL_HELMET) {
            return true;
        }
    ...
    public static boolean isChest(ItemStack itemStack) {
        ...
        if (itemStack.getItem() == Items.CHAINMAIL_CHESTPLATE) {
            return true;
        }
    ...
    public static boolean isLegs(ItemStack itemStack) {
        ...
        if (itemStack.getItem() == Items.CHAINMAIL_LEGGINGS) {
            return true;
        }
    ...
    public static boolean isBoots(ItemStack itemStack) {
        ...
        if (itemStack.getItem() == Items.CHAINMAIL_BOOTS) {
            return true;
        }
